...
/**
     * @override
     */
_onMouseDown:function(t){if(this._moved=!1,this._lastLayerPoint=null,this.options.shiftKey&&!t.shiftKey||this.options.ctrlKey&&!t.ctrlKey||1!==t.which&&1!==t.button)return!1;a.DomEvent.stop(t);t=this._map.mouseEventToLayerPoint(t);if(!this._validate(t))return!1;a.DomUtil.disableTextSelection(),a.DomUtil.disableImageDrag(),this._startLayerPoint=t,a.DomEvent.on(document,"mousemove",this._onMouseMove,this).on(document,"mouseup",this._onMouseUp,this).on(document,"keydown",this._onKeyDown,this)},
/**
     * @override
     */
_onMouseMove:function(t){this._moved||(this._box=a.DomUtil.create("div","leaflet-zoom-box",this._pane),a.DomUtil.setPosition(this._box,this._startLayerPoint),this._map.fire(a.Map.SelectArea.AREA_SELECT_START));var o=this._startLayerPoint,e=this._box,t=this._map.mouseEventToLayerPoint(t),i=t.subtract(o);this._validate(t)&&(this._lastLayerPoint=t,t=new a.Point(Math.min(t.x,o.x),Math.min(t.y,o.y)),a.DomUtil.setPosition(e,t),this._moved=!0,
// TODO refactor: remove hardcoded 4 pixels
e.style.width=Math.max(0,Math.abs(i.x)-4)+"px",e.style.height=Math.max(0,Math.abs(i.y)-4)+"px")},
/**
...
/**
     * @override
     */
_onMouseUp:function(t){this._finish();var o,e,i,s=this._map,n=this._lastLayerPoint;// map.mouseEventToLayerPoint(e);
n&&!this._startLayerPoint.equals(n)&&(a.DomEvent.stop(t),o=s.layerPointToLatLng(this._startLayerPoint),e=s.layerPointToLatLng(n),i=new a.LatLngBounds(o,e),
//map.fitBounds(bounds);
this._autoDisable?this.disable():this._restoreCursor(),this._moved=!1,a.Util.requestAnimFrame(function(){s.fire(a.Map.SelectArea.AREA_SELECTED,{bounds:i,start:o,end:e})}))}}),
// expose setting
